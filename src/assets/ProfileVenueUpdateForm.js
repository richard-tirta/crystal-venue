...
class ProfileVenueUpdateForm extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <form onSubmit={this.handleSubmit}>
                ...
                <VenueForm onChange={this.handleInputChange} errors={this.state.errors} askName={false} venueLocation={this.state.venueLocation}/>
...
export default ProfileVenueUpdateForm;